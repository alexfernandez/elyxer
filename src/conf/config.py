...
# autogenerated from config file on 2010-01-12
...
class FormulaConfig(object):
  ...
  commands = {
      ...
      u'\\Mapsto':u'|⇒', u'\\P':u'¶', u'\\Pr':u'Pr', u'\\RIGHTCIRCLE':u'◗', 
      u'\\RIGHTcircle':u'◑', u'\\Re':u'ℜ', u'\\Rightarrow':u' ⇒ ', 
      u'\\Rrightarrow':u'⇛', u'\\Rsh':u'↱', u'\\S':u'§', u'\\Square':u'☐', 
      u'\\Subset':u'⋐', u'\\Supset':u'⋑', u'\\Uparrow':u'⇑', 
      u'\\Updownarrow':u'⇕', u'\\Vdash':u'⊩', u'\\Vert':u'∥', u'\\Vvdash':u'⊪', 
      u'\\XBox':u'☒', u'\\Yup':u'⅄', u'\\\\':u'<br/>', u'\\_':u'_', 
      ...
      u'\\ge':u' ≥ ', u'\\gemini':u'♊', u'\\geq':u' ≥ ', u'\\geq)':u'≥', 
      u'\\geqq':u'≧', u'\\geqslant':u'≥', u'\\gets':u'←', u'\\gg':u'≫', 
      u'\\ggg':u'⋙', u'\\gimel':u'ℷ', u'\\gneqq':u'≩', u'\\gnsim':u'⋧', 
      u'\\gtrdot':u'⋗', u'\\gtreqless':u'⋚', u'\\gtreqqless':u'⪌', 
      u'\\gtrless':u'≷', u'\\gtrsim':u'≳', u'\\hbar':u'ℏ', u'\\heartsuit':u'♥', 
...
class GeneralConfig(object):
  ...
  version = {
      u'date':u'2010-01-12', u'lyxformat':u'345', u'number':u'0.39', 
      }
...
class TranslationConfig(object):
  ...
  constants = {
      ...
      u'list-table':u'List of Tables', u'list-tableau':u'List of Tableaux', 
