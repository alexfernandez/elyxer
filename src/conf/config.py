...
class FormulaConfig(object):
  ...
  commands = {
      ...
      u'\\Gamma':u'Γ', u'\\Lambda':u'Λ', u'\\Longleftarrow':u'⟸', 
      ...
      u'\\alpha':u'α', u'\\approx':u' ≈ ', u'\\backslash':u'\\', 
      u'\\beta':u'β', u'\\bigstar':u'★', u'\\blacktriangleright':u'▶', 
      u'\\bullet':u'•', u'\\cdot':u'⋅', u'\\chi':u'χ', u'\\circ':u'○', 
      u'\\cos':u'cos', u'\\cosh':u'cosh', u'\\dagger':u'†', 
      u'\\dashrightarrow':u' ⇢ ', u'\\ddagger':u'‡', u'\\ddots':u'⋱', 
      u'\\delta':u'δ', u'\\diamond':u'◇', u'\\displaystyle':u'', 
      u'\\downarrow':u'↓', u'\\end{array}':u'', u'\\epsilon':u'ε', 
      u'\\eta':u'η', u'\\exp':u'exp', u'\\gamma':u'γ', u'\\ge':u' ≥ ', 
      ...
      u'\\neq':u'≠', u'\\nonumber':u'', u'\\not':u'¬', u'\\nu':u'ν', 
      u'\\omega':u'ω', u'\\phi':u'φ', u'\\pi':u'π', u'\\pm':u'±', 
      u'\\prime':u'′', u'\\propto':u' ∝ ', u'\\psi':u'ψ', u'\\quad':u' ', 
      u'\\rangle':u'⟩', u'\\rho':u'ρ', u'\\rightarrow':u' → ', 
      u'\\rightsquigarrow':u' ⇝ ', u'\\scriptscriptstyle':u'', 
      u'\\scriptstyle':u'', u'\\sigma':u'σ', u'\\sim':u' ~ ', u'\\sin':u'sin', 
      u'\\sinh':u'sinh', u'\\square':u'□', 
      u'\\sum':u'<span class="bigsymbol">∑</span>', u'\\tanh':u'tanh', 
      u'\\tau':u'τ', u'\\textstyle':u'', u'\\theta':u'θ', u'\\times':u' × ', 
      u'\\to':u'→', u'\\triangleright':u'▷', u'\\uparrow':u'↑', 
      u'\\upsilon':u'υ', u'\\varsigma':u'ς', u'\\xi':u'ξ', u'\\zeta':u'ζ', 
      u'\\{':u'{', u'\\}':u'}', 
      }
