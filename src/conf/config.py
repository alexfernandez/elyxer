...
# autogenerated from config file on 2009-10-16
...
class FormulaConfig(object):
  ...
  alphacommands = {
      ...
      u'\\varepsilon':u'ε', u'\\varphi':u'φ', u'\\varpi':u'ϖ', 
      u'\\varrho':u'ϱ', u'\\varsigma':u'ς', u'\\vartheta':u'ϑ', u'\\xi':u'ξ', 
      u'\\zeta':u'ζ', 
      }
  ...
  commands = {
      ...
      u'\\textbackslash':u'\\', u'\\textstyle':u'', u'\\tilde{A}':u'Ã', 
      ...
      u'\\tilde{v}':u'ṽ', u'\\tilde{y}':u'ỹ', u'\\times':u' × ', u'\\to':u'→', 
      u'\\top':u'⊤', u'\\triangleleft':u'⊲', u'\\triangleright':u'▷', 
      u'\\twonotes':u'♫', u'\\unlhd':u'⊴', u'\\unrhl':u'⊵', u'\\uparrow':u'↑', 
...
class GeneralConfig(object):
  ...
  version = {
      u'date':u'2009-10-16', u'lyxformat':u'345', u'number':u'0.33', 
      }
