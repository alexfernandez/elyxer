...
# autogenerated from config file on 2009-05-11
...
class ContainerConfig(object):
  ...
  endings = {
      ...
      u'Space':u'\\end_inset', u'Table':u'\\end_inset', 
      u'TableOfContents':u'\\end_inset', u'TableParser':u'</lyxtabular', 
      u'TextFamily':u'\\family', u'Title':u'\\end_layout', 
      u'URL':u'\\end_inset', u'VersalitasText':u'\\noun', 
      u'Wrap':u'\\end_inset', 
      }
...
class GeneralConfig(object):
  ...
  version = {
      u'date':u'2009-05-11', u'number':u'0.21', 
      }
