...
# autogenerated from config file on 2009-05-06
...
class ContainerConfig(object):
  ...
  starts = {
      ...
      u'\\begin_inset':u'Inset', u'\\begin_inset Branch':u'Branch', 
      ...
      u'\\begin_inset Wrap':u'Wrap', u'\\begin_inset space':u'Space', 
      u'\\begin_layout':u'Layout', u'\\begin_layout Author':u'Author', 
...
class FormulaConfig(object):
  ...
  commands = {
      u'\\!':u'', u'\\%':u'%', u'\\,':u' ', u'\\:':u' ', u'\\Gamma':u'Γ', 
      u'\\Rightarrow':u' ⇒ ', u'\\Upsilon':u'Υ', u'\\\\':u'<br/>', u'\\_':u'_', 
